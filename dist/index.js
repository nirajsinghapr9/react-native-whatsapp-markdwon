...
const TextFormatter = (text) => {
    ...
    const escapeHTML = (unsafe) => unsafe
        ...
        .replace(/"/g, "&quot;")
        .replace(/'/g, "&#39;");
    const markdownToText = (textInput) => {
        const escapeMarkdownInUrl = (url) => {
            return url.replace(/[<>"']/g, escapeHTML);
        };
        const processedText = textInput.replace(/(^|\s)(https?:\/\/(?:www\.)?\S+|www\.\S+)/gi, (match, prefix, url) => {
...
exports.default = exports.TextFormatter;
